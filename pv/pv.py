...
class PV:
    ...
    def get_current(self, voltage: float, irrad: list[float], temp: list[float]) -> float:
        ...
        characteristics. We cheat here and pull the I-V curve and interpolate.
    ...
    def get_iv(self, irrad: list[float], temp: list[float]) -> list[list[float, float, float]]:
    ...
    def get_edge(self, irrad: list[float], temp: list[float]) -> ((float, float), (float, float)):
